    ...
    <div class="container">
        ...
        <div class="mobile-header">
            <div class="logo">
                ...
                <div class="mobile-title">List2Do++</div>
            </div>
            <div class="mobile-actions">
                <button id="statsBtn"><i class="fas fa-chart-pie"></i></button>
        ...
        <div class="fab" onclick="addCategory()">
        ...
        <div class="bottom-nav">
            ...
            <a href="https://calendar.google.com/" class="nav-item">
                <i class="fas fa-calendar-alt"></i>
                <span>Kalender</span>
            </a>
            <a href="https://www.spotify.com" class="nav-item">
                <i class="fa-brands fa-spotify"></i>
                <span>Spotify</span>
            </a>
            <a href="https://github.com/frgdps/fles/blob/main/README.md" class="nav-item">
                        ...
                        <div class="category-title">
                            ...
                            <div class="sort-dropdown">
                                ...
                                <div class="sort-options">
                                    <button onclick="sortTasks(${catIndex}, 'name')"><i class="fas fa-sort-alpha-down"></i> Sort by Name</button>
                                    <button onclick="sortTasks(${catIndex}, 'date')"><i class="fas fa-calendar"></i> Sort by Date</button>
                                    <button onclick="sortTasks(${catIndex}, 'completed')"><i class="fas fa-check-circle"></i> Sort by Completed</button>
                                </div>
                            </div>
                        </div>
